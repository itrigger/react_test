...
const MyMap = () => {
    ...
    {/*
       $(".map_bubble").on("click", function () {
      map.setCenter({ lat: 55.7498, lng: 37.6176});
      map.setZoom(16);
    })

    $(".main-page-map .selector-dd li").on("click", function () {
      $(this).parent().parent().find(".selector-title span").text($(this).find("span").attr("data-title"));
      $(this).parent().find("li").each(function () {$(this).removeClass("active");})
      $(this).addClass("active");

      let indexx = $(this).index();
      $(".map_bubble").html(sites[indexx][4]);

      let tlat = parseFloat($(this).attr("data-lat"));
      let tlng = parseFloat($(this).attr("data-lng"));

      map.setCenter({ lat: tlat, lng: tlng});
      map.setZoom(12);
    })
    */}
        ...
        <div className="main-page-map">
            <div className="in">
                <h1>Скупка радиодеталей в
                    <div className="selector main-page-map--selector">
                        <div className="selector-title"><span>Москве</span></div>
                        <ul className="selector-dd">
                            <li className="active" data-lat="55.7498" data-lng="37.6176"><span
                                data-title="Москве">Москва</span></li>
                            <li data-lat="45.0383221" data-lng="38.98791"><span data-title="Краснодаре">Краснодар</span>
                            </li>
                        </ul>
                    </div>
                </h1>
